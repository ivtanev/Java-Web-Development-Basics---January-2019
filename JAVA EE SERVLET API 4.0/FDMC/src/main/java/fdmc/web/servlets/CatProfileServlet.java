...
public class CatProfileServlet extends HttpServlet {
    ...
    private final static String CAT_PROFILE_HTML_FILE_PATH = "C:\\Users\\AVLuser\\Downloads\\FDMC\\src\\main\\resources\\views\\cat-profile.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(cat == null){
            htmlFileContent = this.htmlReader.readHtmlFile("C:\\Users\\AVLuser\\Downloads\\FDMC\\src\\main\\resources\\views\\non-existent-cat.html")
